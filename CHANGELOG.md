...
- Set the default gather distance to 20 metres.
...
- Add Gather Distance to Mod Settings: 10–200 metres in 10-metre steps, with a default of 20 metres. Saved distance changes apply on save load or game restart.
